...
void main() {
  ...
  test(
    'chatTelemetryProvider defaults to the real logging sink, not a no-op',
    () {
      final container = ProviderContainer();
      addTearDown(container.dispose);
      expect(
        container.read(chatTelemetryProvider),
        isA<LoggingChatTelemetry>(),
      );
    },
  );
  ...
  test(
    'LoggingChatTelemetry handles every reconcile signal without throwing',
    () {
